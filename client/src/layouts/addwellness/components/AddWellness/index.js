...
import { FormControl, FormControlLabel, InputLabel, Select, Slider, Typography } from "@mui/material";
    ...
    <Card id="add-wellness" style={{width: 'auto'}}>
      ...
      {isWellnessRequired() ? (
        ...
        {teamData.water && (
          <MDBox pt={1} pb={2} px={2}>
            <MDBox component="ul" display="flex" flexDirection="column" p={0} m={0}>
              <Tooltip title="Based on your goal, enter the percentage of water you consumed today." placement="top-start">
                Water
        ...
        {teamData.sleep && (
          <MDBox pt={1} pb={2} px={2}>
            <MDBox component="ul" display="flex" flexDirection="column" p={0} m={0}>
              <Tooltip title="Amount of sleep, in hours, from the previous night." placement="top-start">
                  Sleep
                  <IconButton color="primary" size="small">
                    <InfoIcon />
                  </IconButton>
